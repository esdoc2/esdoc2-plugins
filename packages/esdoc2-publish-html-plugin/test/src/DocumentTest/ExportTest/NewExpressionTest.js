  ...
  describe('default export', ()=>{
    ...
    it('has class description', ()=>{
      ...
      findParent(doc, '#static-variable-testExportNewExpression', '[data-ice="detail"]', (doc)=>{
        ...
        assert.includes(doc, '[data-ice="importPath"]', `import testExportNewExpression from 'esdoc2-test-fixture/src/Export/NewExpression.js'`);
      });
    });
  });
  ...
  describe('named export', ()=>{
    ...
    it('has class description', ()=>{
      ...
      findParent(doc, '#static-variable-testExportNewExpression2', '[data-ice="detail"]', (doc)=>{
        ...
        assert.includes(doc, '[data-ice="importPath"]', `import {testExportNewExpression2} from 'esdoc2-test-fixture/src/Export/NewExpression.js'`);
      });
    });
  });
});
