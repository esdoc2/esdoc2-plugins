...
describe('test search', ()=>{
  ...
  it('has class index', ()=>{
    assert.deepEqual(find(searchIndex, 'class/src/Desc/Class.js~TestDescClass.html'), [
      'esdoc2-test-fixture/src/desc/class.js~testdescclass',
      'class/src/Desc/Class.js~TestDescClass.html',
      '<span>TestDescClass</span> <span class="search-result-import-path">esdoc2-test-fixture/src/Desc/Class.js</span>',
      'class'
    ]);
  });
  ...
  it('has interface index', ()=>{
    assert.deepEqual(find(searchIndex, 'class/src/Interface/Definition.js~TestInterfaceDefinition.html'), [
      'esdoc2-test-fixture/src/interface/definition.js~testinterfacedefinition',
      'class/src/Interface/Definition.js~TestInterfaceDefinition.html',
      '<span>TestInterfaceDefinition</span> <span class="search-result-import-path">esdoc2-test-fixture/src/Interface/Definition.js</span>',
      'class'
    ]);
  });
  ...
  it('has function index', ()=>{
    assert.deepEqual(find(searchIndex, 'function/index.html#static-function-testDescFunction'), [
      'esdoc2-test-fixture/src/desc/function.js~testdescfunction',
      'function/index.html#static-function-testDescFunction',
      '<span>testDescFunction</span> <span class="search-result-import-path">esdoc2-test-fixture/src/Desc/Function.js</span>',
      'function'
    ]);
  });
  ...
  it('has variable index', ()=>{
    assert.deepEqual(find(searchIndex, 'variable/index.html#static-variable-testDescVariable'), [
      'esdoc2-test-fixture/src/desc/variable.js~testdescvariable',
      'variable/index.html#static-variable-testDescVariable',
      '<span>testDescVariable</span> <span class="search-result-import-path">esdoc2-test-fixture/src/Desc/Variable.js</span>',
      'variable'
    ]);
  });
