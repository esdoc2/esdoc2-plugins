...
// hack
const ESParser = require('esdoc2/out/src/Parser/ESParser').default;
const InvalidCodeLogger = require('esdoc2/out/src/Util/InvalidCodeLogger').default;
const PathResolver = require('esdoc2/out/src/Util/PathResolver').default;
